...
<form method="post" name="frmPersonalPhone" action="PersonalPhoneSave.asp" onsubmit="return validate_form();"> 
<%  
 dim rst 
 dim strsql
...
%>             
	...
	<tr>
	  <td>Phone Number</td>
	  <td width="1px">:</td>
	  <td><input type="input" name="txtPhoneNumber" value='<%=PhoneNumber_ %>' size="50" maxlength="50" /></td>
	</tr> 
	<tr>
	  <td>Remark</td>
	  <td>:</td>
