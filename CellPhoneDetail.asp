  ...
  <tr>
	<td colspan="6" align="Center">
		...
		<tr>
			...
			<table cellspadding="0" cellspacing="0" bordercolor="black" width="100%" bgColor="white">  
			<tr>
				<td>&nbsp;<strong>VPN Network Calls</strong> / <i>Pozivi unutar VPN mre�e<i/></td>
				<td>&nbsp;Kn.</td>
				<td align="right"><%=formatnumber(LocalCall_,-1) %>&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;<strong>Calls to VIP Network</strong> / <i>Pozivi prema VIP mobilnoj mre�i<i/></td>
				<td>&nbsp;Kn.</td>
				<td align="right"><%=formatnumber(BalanceDue_,-1) %>&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;<strong>Calls to Landlines in Croatia</strong> / <i>Pozivi prema fiksnim mre�ama u Hrvatskoj<i/></td>
				<td>&nbsp;Kn.</td>
				<td align="right"><%=formatnumber(Interlocal_,-1) %>&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;<strong>Calls to Other Mobile Networks</strong> / <i>Pozivi prema ostalim mobilnim mre�ama<i/></td>
				<td>&nbsp;Kn.</td>
