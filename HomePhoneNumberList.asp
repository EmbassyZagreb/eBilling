...
<!--#include file="Header.inc" -->
  <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">HOME PHONE NUMBER LIST</TD>
   </TR>
<tr>
...
<!--
		<tr>
			<td>&nbsp;Phone Type</td>
			<td>:</td>
			<td colspan="4"><select name="PhoneTypeList">
				<option value="A">-All-</option>
...
-->
     ...
     <table width="100%">
	<tr>
		<td width="50%"><a href="HomePhoneNumberEdit.asp?State=I">Add New Home Phone Number</a></td>
		<td align="right"><input type="button" name="btnExport" value="Export to Excel" onClick="javascript:document.location.href('HomePhoneNumberListPrint.asp?Post=<%=Post_%>&Section=<%=Section_%>&EmpName=<%=EmpName_%>&PhoneNumber=<%=PhoneNumber_%>&PhoneType=<%=PhoneType_ %>&Charge=<%=Charge_ %>&SortBy=<%=SortBy_%>&Order=<%=Order_%>');"/></td>
	</tr>
     </table>
     ...
     <TR BGCOLOR="#330099" align="center">
         ...
         <TD width="15%"><strong><label STYLE=color:#FFFFFF>&nbsp;Phone Number</label></strong></TD>
<!--         <TD width="10%"><strong><label STYLE=color:#FFFFFF>&nbsp;Customer No.</label></strong></TD>
         <TD><strong><label STYLE=color:#FFFFFF>&nbsp;Customer Name</label></strong></TD>
-->
...
<!--         <TD width="12%"><strong><label STYLE=color:#FFFFFF>&nbsp;Phone Type</label></strong></TD>-->
	 ...
	 <TD><strong><label STYLE=color:#FFFFFF>&nbsp;Charged</label></strong>
...
%>
     ...
     <TR bgcolor="<%=bg%>">
        ...
        <TD><FONT color=#330099 size=2><A HREF="HomePhoneNumberEdit.asp?ID=<%= rs("ID")%>&State=E"> <%= rs("PhoneNumber") %></A></font>   </TD>
...
<!--        <TD><FONT color=#330099 size=2>&nbsp;<%= rs("PhoneTypeName") %></font>   </TD>-->
	<TD><FONT color=#330099 size=2><A HREF="HomePhoneNumberDeleteConfirm.asp?ID=<%= rs("ID")%>&State=D" >Delete</A></font>   </TD>
	<td align="center">
...
%>
	...
	%>		
				...
				<%Else%>
					<a href="HomePhoneNumberList.asp?PageIndex=<%=PageNo%>&Post=<%=Post_%>&Section=<%=Section_%>&EmpName=<%=EmpName_%>&PhoneNumber=<%=PhoneNumber_%>&PhoneType=<%=PhoneType_ %>&Charge=<%=Charge_ %>&SortBy=<%=SortBy_%>&Order=<%=Order_%>"><%=PageNo%></a>&nbsp;
	<%	
				End If						
				PageNo=PageNo+1
			Loop
