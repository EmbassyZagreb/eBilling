...
dim hlm
%>
<form method="post" name="frmSearch" Action="BillingApprovalListAddon.asp">
...
if not DataRS.eof Then
%>
<form name="frmBillingList" Action="BillingApprovalAllAddOn.asp" onSubmit="return ValidateForm()">
<table width="100%">
<tr>
...
<table border="1" bordercolor="#000000" cellpadding="2" cellspacing="0" width="100%"  class="FontText">
    <TR BGCOLOR="#330099" align="center">
	 ...
	 <TD colspan="4"><strong><label STYLE=color:#FFFFFF>Billing Amount (Kn.)</label></strong></TD>
	 <TD colspan="5"><strong><label STYLE=color:#FFFFFF>Personal Billing Amount (Kn.)</label></strong></TD>
...
%>
	   ...
	   <TR bgcolor="<%=bg%>">
		...
		<%if DataRS("ProgressID")=2 then %>
			<A HREF="BillingApprovalAddOn.asp?EmpID=<%= DataRS("EmpID")%>&Month=<%=DataRS("MonthP")%>&Year=<%=DataRS("YearP")%>&LoginID=<%=DataRS("LoginID")%>"><%=DataRS("EmpName") %></A>
		<%else%>
			<%=DataRS("EmpName") %>
		<%end if%>
		</TD>
...
<!--	        <TD><FONT color=#330099 size=2>&nbsp;<%=DataRS("WorkPhone") %> </font></TD> -->
	        ...
	        <TD align="right"><FONT color=#330099 size=2><%= formatnumber(DataRS("OfficePhoneBillRp"),-1) %>&nbsp;</font></TD>
	        <TD align="right"><FONT color=#330099 size=2><%= formatnumber(DataRS("CellPhoneBillRp"),-1) %>&nbsp;</font></TD>
	        ...
	        <TD align="right"><FONT color=#330099 size=2><%= formatnumber(DataRS("CellPhonePrsBillRp"),-1) %>&nbsp;</font></TD>
	        <TD align="right"><FONT color=#330099 size=2><%= formatnumber(DataRS("TotalShuttleBillRp"),-1) %>&nbsp;</font></TD>
...
%>
	...
	<tr>
		<td align="center"><a href="DefaultAddOn.asp"><img src="images/Back.gif" border="0" alt="Go..Back" WIDTH="83" HEIGHT="25"></a></td>
	</tr>	
	</table>
<% end if %>
</body> 
