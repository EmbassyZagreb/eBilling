...
-->
				<li><A HREF="1MonthlyBilling.asp"><B>Monthly Billing</B></A></li>
...
<!--				<li><A HREF="BillingApprovalList.asp"><B>Office Phone</B></A></li> -->
				<li><A HREF="1BillingApproval.asp"><B>Approval List</B></A></li>
			</ul>	
		...
		<br><LI class="normal">
			<b>Admins:</b>
				<UL TYPE="">
					...
					<LI><A HREF="ImportMain.asp"><B>Import New Bill</B></A>
					<LI><A HREF="Maintenancemode.asp"><B>Maintenance Mode</B></A>
...
<!--				<li><A HREF="ExchangeRateList.asp"><B>Exchange Rate</B></A></li> -->
				...
				<li><A HREF="1SendNotification.asp"><B>Send Notification</B></A></li>
