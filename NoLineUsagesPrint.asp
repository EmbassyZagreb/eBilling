...
<tr>
	<td colspan="6" align="center">Non Line Usages Report</td>
</tr>
...
%>
	...
	<TR BGCOLOR="#000099" align="center" cellpadding="0" cellspacing="0" >
		...
		<TD class="style5">Post</TD>
	       	<TD width="15%" class="style5">Agency</TD>
		<TD width="10%" class="style5">Office</TD>
		<TD width="10%" class="style5">Phone Number</TD>
	</TR>    
	<% 
		dim no_  
		no_ = 1 
