...
<!--#include file="Header.inc" -->
  <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">Log Detail</TD>
   </TR>
  <TR>
...
<tr>
         <TD width="70px"><strong>Log Type :</strong></TD>
	 <td><%=DataRS("ProgressDesc") %></td>
	 <td align="right"><input type="button" name="btnExport" value="Export to Excel" onClick="javascript:document.location.href('LogDetailExcel.asp?MonthP=<%=MonthP_%>&YearP=<%=YearP_%>&ProgressID=<%=ProgressID_%>');"/></td>
</tr>
</table>
