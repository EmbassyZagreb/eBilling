...
<table border="1" bordercolor="#000000" cellpadding="2" cellspacing="0" width="100%"  class="FontText">
    <TR BGCOLOR="#330099" align="center">
         ...
         <TD rowspan="2" width="5%"><strong><label STYLE=color:#FFFFFF>Billing Period</label></strong></TD>
...
<!--         <TD><strong><label STYLE=color:#FFFFFF>Note</label></strong></TD> -->
         <TD rowspan="2">
		<strong><label STYLE=color:#FFFFFF>Approved By</label></strong>
	 </TD>
         <TD rowspan="2"">
		<strong><label STYLE=color:#FFFFFF>Status</label></strong>
	 </TD>
         <TD rowspan="2">
		<strong><label STYLE=color:#FFFFFF>Note</label></strong>
	 </TD>
    </TR>
    <tr BGCOLOR="#330099" align="center">
...
<%		End If %>
		...
		<TD><FONT color=#330099 size=2>&nbsp;<%= DataRS("ApprovalSupervisor") %></font></TD>
		<TD><FONT color=#330099 size=2>&nbsp;<%= DataRS("ProgressDesc") %></font></TD>
		<TD><FONT color=#330099 size=2>&nbsp;<%= DataRS("Note") %></font></TD>
	   </TR>
