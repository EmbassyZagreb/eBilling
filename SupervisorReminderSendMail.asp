...
'		response.write strsql & "<Br>"  
		...
		objMail.To = send_to 	
		objMail.Subject = "Action Required: zBilling System � Approval Request Repeat Notice"
		...
		ObjMail.HTMLBody = ObjMail.HTMLBody & " "_	
					...
					& "    <tr> "_           
					& "        <td colspan='6' align='center'><font face='Verdana, Arial, Helvetica' color='#999999' size='5'>zBilling System � Supervisor Reminder</font></td></tr> "_
					& "    <tr> "_       
