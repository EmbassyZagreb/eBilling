...
'response.write ID_
	...
	strsql = "select PhoneNumber from MsOfficePhoneNumber Where ID=" & ID_
...
<!--#include file="Header.inc" -->
   <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">OFFICE PHONE DELETED</TD>
   </TR>
<tr>
...
<form method="post" action="OfficePhoneNumberDelete.asp"> 
