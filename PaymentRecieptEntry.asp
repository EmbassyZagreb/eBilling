...
<!--	<Select name="cmbCurrencyType" onChange="CurrencyOnChange(this);">
		...
		</select>&nbsp; --> <input type="input" align="right" name="txtPaidAmount" size="10" value='<%= formatnumber(RemainingBillRp_ ,-1,,,0) %>' /> * if the paid amount is less then suggested, the billing status will remain 'Paid Partial'</td>
