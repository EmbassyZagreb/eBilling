...
<table border="1" bordercolor="#000000" cellpadding="2" cellspacing="0" width="100%"  class="FontText">
    <TR BGCOLOR="#330099" align="center">
         <TD rowspan="2" width="4px" align="right"><strong><label STYLE=color:#FFFFFF>No.</label></strong></TD>
	 ...
	 <TD colspan="5"><strong><label STYLE=color:#FFFFFF>Billing Amount (Kn.)</label></strong></TD>
         <TD rowspan="2"><strong><label STYLE=color:#FFFFFF>Aging</label></strong></TD>
         <TD rowspan="2"><strong><label STYLE=color:#FFFFFF>Supervisor</label></strong></TD>
         <TD rowspan="2"><strong><label STYLE=color:#FFFFFF>Supervisor Email</label></strong></TD>
...
<%		End If %>
		&nbsp;</td>
	        ...
	        <TD><FONT color=#330099 size=2>&nbsp;<%=DataRS("Supervisor") %> </font></TD>
	        <TD><FONT color=#330099 size=2>&nbsp;<%=DataRS("SupervisorEmail") %> </font></TD>
		<td align="center">
