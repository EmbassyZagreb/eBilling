...
<table border="1" bordercolor="#000000" cellpadding="2" cellspacing="0" width="100%"  class="FontText">
    <TR BGCOLOR="#330099" align="center">
         ...
         <TD rowspan="2" width="8%" class="style5">Section</TD>
	 <TD colspan="5" class="style5">Billing Amount (Kn.)</TD>
	 <TD rowspan="2" class="style5">Aging</TD>
	 <TD rowspan="2" class="style5">Supervisor</TD>
	 <TD rowspan="2" class="style5">Supervisor Email</TD>
    </TR>
    <tr BGCOLOR="#330099" align="center">
...
<%		End If %>
	        ...
	        <TD align="right"><FONT color=#330099 size=2><%= formatnumber(DataRS("TotalBillingAmountPrsRp"),2) %></font></TD>
