...
<div id="container">
	...
	<div id="navigation">
					...
					<%		if (ProgressID_ = 1) or (ProgressID_ = 3) then%>
								<input type="submit" id="Accept" name="btnSubmit" Value="Submit to Supervisor"/>
							<div id="Hide" style="display:none">
							<table class="details">
								<tr class="details_title">
									<td>Update change(s) to enable button!</td>
								</tr>
							</table>
							</div>								
...
& " <title>z-Billing Application</title> "_
		...
		& "    <tr> "_
		& "        <td colspan='6' align='center'><font face='Verdana, Arial, Helvetica' color='#999999' size='6'>eBilling System – Approval Request</font></td></tr> "_
		& "    <tr> "_
