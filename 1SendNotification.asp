						...
						<%
							...
							For i = 0 To (NrOfMonths - 1)
								...
								If (CInt(arrResultSet (6,j)) = m AND CInt(arrResultSet (7,j)) = y) Then
									...
									j = j + 1
								End If
								iVoid = GraphHeight - iHeightNotSent - iHeightSent
								...
								End If
								If iNotSent > 0  Then Response.Write "<img src=""" & BarColorNotSent & """ width=""" & BarWidth & """ height=""" & iHeightNotSent & """ alt="""" title=""" & iNotSent & """ /><br />"
								If iSent > 0  Then Response.Write "<img src=""" & BarColorSent & """ width=""" & BarWidth & """ height=""" & iHeightSent& """ alt="""" title=""" & iSent & """ />"
								If m = MonthP Then
								...
								If iReSent > 0  Then Response.Write "<img src=""" & BarColorReSent & """ width=""" & BarWidth & """ height=""" & iHeightReSent & """ alt="""" title=""Resent"" />" & "<br />" & iReSent & ""
								Response.Write "<br><img src=""" & TransparentPix & """ width=""0"" height=""" & GraphHeight - iHeightReSent & """ alt="""" title=""Resent"" /></div></a></td>"
							Next
							Response.Write "</tr>"
		...
		if EmpEmail_ <>"" Then
			...
			if ProgressID_ ="7" then
				...
				ObjMail.HTMLBody = ObjMail.HTMLBody & " "_
					...
					& "    <tr> "_
					& "        <td colspan='6' align='center'><font face='Verdana, Arial, Helvetica' color='#999999' size='6'>zBilling System - No Invoice This Period</font></td></tr> "_
					& "    <tr> "_
...
'				objMail.Subject = "e-Billing System - Monthly Billing Reminder for period " & Period_
				...
				if AlternateEmailFlag_ ="N" and DummyFlag_="N" Then
					...
					& " <p><table cellspadding='1' cellspacing='0' width='80%' bgColor='white'>"_
					& "    <tr> "_
					& "        <td colspan='6' align='center'><font face='Verdana, Arial, Helvetica' color='#999999' size='6'>zBilling System – Monthly Bill</font></td></tr> "_
					& "    <tr> "_
					& "        <td colspan='6'>&nbsp; </td></tr> "_
					& "    <tr> "_
