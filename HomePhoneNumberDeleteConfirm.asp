...
'response.write ID_
	...
	strsql = "select PhoneNumber from MsHomePhoneNumber Where ID=" & ID_
...
<!--#include file="Header.inc" -->
  <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">HOME PHONE DELETED</TD>
   </TR>
<tr>
...
<form method="post" action="HomePhoneNumberDelete.asp"> 
