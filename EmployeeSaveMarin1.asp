...
Post_ =  trim(request.form("txtPost"))
OfficeSection_ = trim(request.form("txtOffice")) 
...
<%
	strsql = "Exec spEmployee_IUD '" & State_ & "','" & EmpID_ & "','" & EmpName_  & "'," & FundingAgency_ & ",'" & Post_ & "','" & EmpType_ & "','" & OfficeSection_ & "','" & WorkingTitle_ & "','" & EmailAddress_ & "','" & AlternateEmail_ & "','" & ReportTo_ & "','" & LoginID_ & "','" & Remark_ & "','" & Status_ & "','" & UserName_ & "'"
