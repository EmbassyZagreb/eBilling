...
%>               
	...
	<tr><td colspan='2' width='50%'>
		<table cellspacing='0' border='1' bordercolor='black'>
			<tr><td colspan='2' align='Center'><b>Payee Info</b></td></tr>
		...
		<table cellspacing='0'>
		<tr><td colspan='4'><b><font color='red' size='5'>Bill of Collection</font></td></tr>
...
<%
		 ...
		 Loop 
%>
	<tr><td colspan='3' align='center'><b>Total</b></td><td align='right'><b>$ <%=formatnumber(TotalBillDlr_,-1)%></b>&nbsp;</td><td>&nbsp;</td><td align='right'><b>IDR <%=formatnumber(TotalBillRp_,-1)%></b>&nbsp;</td></tr></table></td></tr>
	</table><div align='right'><i>*Please remit payment within 15 days of the Invoice Date</i></div>
	<br><br><br><div align='left'><b>Payment Options</b></div>
	...
	<br><br><br><div align='left'><b>Fund Cite Details (For Cashier)</b></div>
