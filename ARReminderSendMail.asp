...
'		response.write strsql & "<Br>"  
		...
		ObjMail.HTMLBody = ObjMail.HTMLBody & " "_
		& "    	<td class='FontContent'>&nbsp;<a href='" & WebSiteAddress & "/1MonthlyBilling.asp?CellPhone=" & MobilePhone_ & "&MonthP=" & MonthP_ & "&YearP=" & YearP_ & "' target='_blank'>Tick your calls</a></td> "

		else

		ObjMail.HTMLBody = ObjMail.HTMLBody & " "_
		& "    	<td class='FontContent'>&nbsp;<a href='" & WebSiteAddress & "/1MonthlyBilling.asp?CellPhone=" & MobilePhone_ & "&MonthP=" & MonthP_ & "&YearP=" & YearP_ & "' target='_blank'>View Submitted Bill</a></td> "
		...
		& "        <p>You must take action. Click <A HREF='" & WebSiteAddress & "/1MonthlyBilling.asp'>Here</A> to review your invoice. </p><p>&nbsp;</p></td> "_  
		& "    <tr> "_       
		& "        <td colspan='6'>&nbsp; </td></tr> "_      
		& "    <tr> "_       
		& "        <td colspan='6'>&nbsp; </td></tr> "      
