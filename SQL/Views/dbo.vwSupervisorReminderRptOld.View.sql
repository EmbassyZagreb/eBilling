/****** Object:  View [dbo].[vwSupervisorReminderRptOld]    Script Date: 12/02/2014 15:00:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO
-- Update vwSupervisorReminderRpt
CREATE VIEW [dbo].[vwSupervisorReminderRptOld]
AS
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwSupervisorReminderRptOld'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwSupervisorReminderRptOld'
GO
