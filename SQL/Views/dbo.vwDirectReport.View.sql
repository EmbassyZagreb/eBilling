...
AS
SELECT DISTINCT 
                      EmpID, EmpName, Post AS PostName, Agency, Office, CASE WHEN A.Office IN ('CLO', 'FMO/Bud', 'FMO/Cash', 'FMO/VOU', 'GSO', 'GSO/Motor', 
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwDirectReport'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwDirectReport'
GO
