...
<CENTER>
  ...
  <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">Send Bill Invoice Notification</TD>
   </TR>
<tr>
...
%>  
<form method="post" name="frmSearch" Action="SendNotificationSendMailAll.asp" onSubmit="return confirm('If you continue, all invoices will be sent to users, Are you sure you want to continue?');">
...
<!--				<input type="submit" name="Submit" value="Process" LANGUAGE=javascript onclick="return Send_onclick(frmSearch)"> -->
				<input type="submit" name="Submit" value="Send to all users">
			</td>
		</tr>
		<tr>
