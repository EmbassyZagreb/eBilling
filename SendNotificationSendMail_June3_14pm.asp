...
'			objMail.Subject = "e-Billing System - Monthly Billing Reminder for period " & Period_
	...
	'			end if
				...
				& "    <tr> "_       
				& "        <td colspan='6'> "_
				& "        <p>You must take action. Click <a href='http://jakartaws01.eap.state.sbu/eBilling/MonthlyBilling.asp?Month="& MonthP_ & "&Year=" & YearP_ &"' target='_blank'>Here </a> to review your invoice.</p></td> "_  
				...
				objFile.Writeline "				<td align='right'><b><u>" & formatnumber(CellPhonePrsBillRp_ ,0) & "</u></b>&nbsp;</td>"
				objFile.Writeline "			</tr>"
				...
				& " <p><table cellspadding='1' cellspacing='0' width='80%' bgColor='white'>"_    
				& "    <tr> "_       
				& "        <td colspan='6'>You have received this email before the phone number below is assigned to a group, an employee without open-net access, or an employee who is responsible for multiple phones.  Please follow the instructions below:</td> "_
				& "    </tr> "_ 
				& "    <tr> "_
				...
				& "    </tr> "_ 				
				& "    <tr> "_
				& "        <td colspan='6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a.If personal calls amount to <b>less than or equal to 10,000 rupiah</b>, reply to this email and write “No Payment”.</td> "_
				& "    </tr> "_ 				
				& "    <tr> "_
				& "        <td colspan='6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;in the email content.</td> "_
				& "    </tr> "_ 				
				& "    <tr> "_
				& "        <td colspan='6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b.If the personal calls amount to <b>more than 10,000 rupiah ,</b>, print this email, write in the personal call amount</td> "_ 
				& "    </tr> "_ 
				& "    <tr> "_
