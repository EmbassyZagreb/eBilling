...
<form method="post" action="EmployeeSaveMarin1.asp" name="frmEmployee" onsubmit="return validate_form()"> 
<%  
 dim rst 
 dim strsql
...
<tr>
  <td>Working Title :</td>
  <td><input type="input" name="txtWorkingTitle" value='<%=Office_ %>' size="50" maxlength="50" /></td>
</tr>
<tr>
  <td>Post :</td>
