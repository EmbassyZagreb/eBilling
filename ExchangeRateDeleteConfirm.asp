...
<% dim ExchangeID_
   ExchangeID_ =  trim(request("ExchangeID"))
   State_ =  trim(request("State"))
'response.write ExchangeID_ 
%>
...
<!--#include file="Header.inc" -->
  <TR>
  	<TD COLSPAN="4" ALIGN="center" Class="title">EXCHANGE RATE DELETE</TD>
   </TR>
<tr>
...
<form method="post" action="ExchangeRateDelete.asp"> 
