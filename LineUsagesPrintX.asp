...
%>	
	...
	<tr align="center">
		<td><h3>Line usages Report</h3></td>
	</tr>
	<tr align="center">
	...
	<TR BGCOLOR="#000099" align="center" cellpadding="0" cellspacing="0" >
		...
		<TD class="style5">Employee Name</TD>
	       	<TD width="14%" class="style5">Total Call</TD>
		<TD width="10%" class="style5">Total Duration (Second)</TD>
		<TD width="10%" class="style5">Total Cost</TD>
	</TR> 
	<% 
		dim no_  
		no_ = 1 
