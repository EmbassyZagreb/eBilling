...
<%
	...
	strsql = "Update BillingHd Set Status='P', PaidAmount=" & PaidAmount_ & ", ReceiptNo='" & ReceiptNo_ & "', PaidDate ='" & PaidDate_ & "', CashierRemark ='" & CashierRemark_ & "' Where Extension='" & Extension_ & "' And MonthP='" & MonthP_ & "' And YearP='" & YearP_ & "'"
...
<tr>
	<td colspan="2" align=center>
		<input type="button" value="Back" id="btnMain" onclick="javascript:document.location.href('OfficePhonePaymentList.asp')">
