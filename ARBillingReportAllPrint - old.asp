...
<table border="1" bordercolor="#000000" cellpadding="2" cellspacing="0" width="100%"  class="FontText">
    <TR BGCOLOR="#330099" align="center">
         ...
         <TD rowspan="2" width="15%" class="style5">Employee Name</label></strong></TD>
         <TD rowspan="2" width="10%" class="style5">Billing Period</label></strong></TD>
         <TD rowspan="2" width="8%" class="style5">Section</label></strong></TD>
	 <TD colspan="4" class="style5">Billing Amount (Kn.)</label></strong></TD>
	 <TD colspan="5" class="style5">Personal Billing Amount (Kn.)</TD>
         <TD rowspan="2" class="style5">Approved By</TD>
         <TD rowspan="2" class="style5">Status</TD>
         <TD rowspan="2" class="style5">Note</TD>
    </TR>
    <tr BGCOLOR="#330099" align="center">
